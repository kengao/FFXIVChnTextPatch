...
public class ConfigApplicationPanel extends JFrame implements ActionListener {
	...
	private JButton detailButton = new JButton("詳細設定");
	...
	public ConfigApplicationPanel() {
		...
		setBounds((this.dimension.width - 290) / 2, (this.dimension.height - 190) / 2, 290, 250);
		setResizable(false);
		...
		add(this.titlePanel);
		// 外框尺寸
		this.bodyPanel.setBounds(0, 0, 290, 250);
		...
		add(this.rText, 0);
		this.detailButton.setBounds(180, 190, 80, 20);
		this.detailButton.setFont(new Font("Microsoft Yahei", 1, 12));
		this.detailButton.setForeground(new Color(110, 110, 110));
		this.detailButton.setMargin(new Insets(0, 0, 0, 0));
		this.detailButton.setOpaque(false);
		this.detailButton.setIconTextGap(0);
		this.detailButton.setContentAreaFilled(false);
		this.detailButton.setFocusable(false);
		this.detailButton.addActionListener(this);
		add(this.detailButton, 0);
		
		this.configButton.setBounds(30, 220, 80, 20);
		...
		this.exitButton.setBounds(180, 220, 80, 20);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.detailButton) {
			CsvFilePanel csvFilePanel = new CsvFilePanel("resource" + File.separator + "rawexd");
            csvFilePanel.setVisible(true);
		}
